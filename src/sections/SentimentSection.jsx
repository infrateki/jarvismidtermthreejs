                ...
                <AreaChart data={DAILY_SENTIMENT} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  <defs>
                    ...
                    <linearGradient id="frustGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="#FF4D6A" stopOpacity={0.5} />
                  ...
                  <Area type="monotone" dataKey="productive" name="Productive" stroke="#00F0FF" strokeWidth={1.5} fill="url(#prodGrad)" dot={false} stackId="s" />
                  <Area type="monotone" dataKey="exploratory" name="Exploratory" stroke="#FFB547" strokeWidth={1.5} fill="url(#explorGrad)" dot={false} stackId="s" />
                  <Area type="monotone" dataKey="frustrated" name="Frustrated" stroke="#FF4D6A" strokeWidth={1.5} fill="url(#frustGrad)" dot={false} stackId="s" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
