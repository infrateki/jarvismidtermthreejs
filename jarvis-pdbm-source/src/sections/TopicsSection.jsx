            ...
            <div className="glass-card" style={{ padding: 32 }}>
              ...
              <ResponsiveContainer width="100%" height={320}>
                <BarChart layout="vertical" data={TOPICS} margin={{ top: 0, right: 10, left: 20, bottom: 0 }}>
                  ...
                  <XAxis type="number" tick={{ fill: 'rgba(200,214,229,0.25)', fontSize: 10 }} axisLine={false} tickLine={false} />
                  <YAxis type="category" dataKey="topic" tick={{ fill: 'rgba(200,214,229,0.55)', fontSize: 12 }} axisLine={false} tickLine={false} width={85} />
            ...
            <div className="glass-card" style={{ padding: 32 }}>
              ...
              <ResponsiveContainer width="100%" height={320}>
                <RadarChart data={ACTION_VERBS}>
                  ...
                  <PolarAngleAxis dataKey="verb" tick={{ fill: 'rgba(200,214,229,0.55)', fontSize: 11 }} />
                  <PolarRadiusAxis tick={false} axisLine={false} domain={[0, 10]} />
                  <Radar name="Weight" dataKey="weight" stroke="#00F0FF" fill="#00F0FF" fillOpacity={0.15} strokeWidth={2} />
                </RadarChart>
              </ResponsiveContainer>
